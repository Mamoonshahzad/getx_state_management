...
class TutOneTwoThemePlusDialogue extends StatefulWidget {
  const TutOneTwoThemePlusDialogue({super.key});

  @override
  State<TutOneTwoThemePlusDialogue> createState() =>
      _TutOneTwoThemePlusDialogueState();
}

class _TutOneTwoThemePlusDialogueState
    extends State<TutOneTwoThemePlusDialogue> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text('Theme Screen')),
      body: ListView(
        children: [
          Card(
